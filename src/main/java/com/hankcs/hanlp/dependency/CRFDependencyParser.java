...
public class CRFDependencyParser extends AbstractDependencyParser {
    ...
    private CRFDependencyParser(String modelPath) {
    ...
    private static int convertOffset2Index(CRFModelForDependency.DTag dTag, Table table, int current) {
        int posCount = 0;
        if (dTag.offset > 0) {
    ...
    private boolean loadDat(String path) {
    ...
    static class CRFModelForDependency extends CRFModel {
        ...
        CRFModelForDependency(ITrie<FeatureFunction> featureFunctionTrie) {
