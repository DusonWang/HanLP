...
public class MaxEntDependencyModelMaker {
    private static boolean makeModel(String corpusLoadPath, String modelSavePath) throws IOException {
    ...
    private static Collection<String> generateSingleWordContext(CoNLLWord[] word, int index, String mark) {
    ...
    private static Collection<String> generateUniContext(CoNLLWord[] word, int i, int j) {
