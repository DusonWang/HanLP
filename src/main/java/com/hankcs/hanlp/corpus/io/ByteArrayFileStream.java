...
public class ByteArrayFileStream extends ByteArrayStream {
    ...
    private ByteArrayFileStream(byte[] bytes, int bufferSize, FileChannel fileChannel) {
    ...
    static ByteArrayFileStream createByteArrayFileStream(FileInputStream fileInputStream) throws IOException {
