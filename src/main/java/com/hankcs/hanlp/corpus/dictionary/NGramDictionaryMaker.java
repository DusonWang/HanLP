...
public class NGramDictionaryMaker {
     ...
     * 转移矩阵
     */
    private TMDictionaryMaker tmDictionaryMaker;
    ...
    void addPair(IWord first, IWord second) {
     ...
     * @return
     */
    private boolean saveNGramToTxt(String path) {
        try {
     ...
     * @return
     */
    private boolean saveTransformMatrixToTxt(String path) {
