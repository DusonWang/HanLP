...
public class TonePinyinString2PinyinConverter {
     ...
     * 带音调的字母到Pinyin的map
     */
    private static Map<String, Pinyin> mapKey;
    /**
     * 带数字音调的字幕到Pinyin的map
     */
    private static Map<String, Pinyin> mapNumberKey;
     ...
     * @return
     */
    private static boolean valid(String singlePinyin) {
    ...
    public static List<Pinyin> convert(String[] pinyinArray) {
        ...
        for (String aPinyinArray : pinyinArray) {
            pinyinList.add(mapKey.get(aPinyinArray));
        }
