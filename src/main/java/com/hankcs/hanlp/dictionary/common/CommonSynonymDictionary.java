...
public class CommonSynonymDictionary {
    private DoubleArrayTrie<SynonymItem> trie;
    ...
    public static class SynonymItem {
        ...
        SynonymItem(Synonym entry, List<Synonym> synonymList, Type type) {
            this.entry = entry;
            this.synonymList = synonymList;
            this.type = type;
        }

        SynonymItem(Synonym entry, List<Synonym> synonymList, char type) {
            this.entry = entry;
            this.synonymList = synonymList;
            switch (type) {
                case '=':
        ...
        public static SynonymItem createUndefined(String word) {
            return new SynonymItem(new Synonym(word, word.hashCode() * 1000000 + Long.MAX_VALUE / 3), null, Type.UNDEFINED);
        }
