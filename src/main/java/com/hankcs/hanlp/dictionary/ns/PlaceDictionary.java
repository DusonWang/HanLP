...
public class PlaceDictionary {
     ...
     * 本词典专注的词的ID
     */
    private static final int WORD_ID = CoreDictionary.getWordID(Predefine.TAG_PLACE);
    /**
     * 本词典专注的词的属性
     */
    private static final CoreDictionary.Attribute ATTRIBUTE = CoreDictionary.get(WORD_ID);
    /**
     * 地名词典
     */
...
//        ListIterator<Vertex> listIterator = vertexList.listIterator();
     ...
     * @return
     */
    private static boolean isBadCase(String name) {
        EnumItem<NS> nrEnumItem = dictionary.get(name);
        return nrEnumItem != null && nrEnumItem.containsLabel(NS.Z);
    }
}
