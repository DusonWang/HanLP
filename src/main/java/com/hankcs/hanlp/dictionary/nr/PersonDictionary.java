...
public class PersonDictionary {
    private static final CoreDictionary.Attribute ATTRIBUTE = new CoreDictionary.Attribute(Nature.nr, 100);
    /**
     * 人名词典
     */
...
//                        }
    ...
    private static boolean isBadCase(String name) {
        ...
        return nrEnumItem != null && nrEnumItem.containsLabel(NR.A);
    }
}
