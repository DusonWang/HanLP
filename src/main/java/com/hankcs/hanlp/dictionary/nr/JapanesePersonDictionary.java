...
public class JapanesePersonDictionary {
    ...
    private static String path = HanLP.Config.JapanesePersonDictionaryPath;
    private static DoubleArrayTrie<Character> trie;
     ...
     * @return
     */
    private static boolean saveDat(TreeMap<String, Character> map) {
        try {
    ...
    public static boolean containsKey(String key, int length) {
        return trie.containsKey(key) && key.length() >= length;
    }
